        ...
        <div className="text-center py-6">
          {isLoading ? (
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-500">Market data could not be fetched</p>
              {onRetry && (
                <button 
                  onClick={onRetry}
                  className="mt-2 px-3 py-1 text-xs flex items-center justify-center mx-auto bg-blue-50 hover:bg-blue-100 text-blue-600 rounded-md transition-colors"
                >
